...
public class CaptureManagerX {
    ...
    public CaptureManagerX(Activity activity, DecoratedBarcodeView barcodeView) {
        this.activity = activity;
        this.barcodeView = barcodeView;
        System.out.println(barcodeView.getX());
    ...
    public static void setCameraPermissionReqCode(int cameraPermissionReqCode) {
        CaptureManagerX.cameraPermissionReqCode = cameraPermissionReqCode;
    }
}
